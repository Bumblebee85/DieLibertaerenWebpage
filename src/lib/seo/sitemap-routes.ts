...
export const staticSitemapRoutes: SitemapEntry[] = [
  ...
  { path: "/werde-unterstuetzer", changeFrequency: "monthly", priority: 0.75 },
  { path: "/freiheitsbewegung", changeFrequency: "monthly", priority: 0.7 },
  { path: "/beirat", changeFrequency: "monthly", priority: 0.7 },
